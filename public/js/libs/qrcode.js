				...
				b = a.extend({}, {
					...
					for (a.addData(utf16to8(b.text)), a.make(),
						...
						b.src && (e = new Image(),e.crossOrigin='anonymous', e.src = b.src, e.onload = function() {
							d.fillStyle="#FFFFFF";
							var padding = 10;
							d.roundRect((b.width-b.imgWidth-padding)/2, (b.width-b.imgWidth-padding)/2, b.imgWidth+padding,b.imgHeight+padding, 10 * 1 || 0);
							d.fill();
							//画图片
							d.drawImage(e, (b.width - b.imgWidth) / 2, (b.height - b.imgHeight) / 2,
									b.imgWidth, b.imgHeight);										
							if("function" == typeof loadImgComplete){
								loadImgComplete();
							}else{
								console.error("not find loadImgComplete function");
							}
