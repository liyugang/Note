(function($, root) {
  ...
  ZdVideo.prototype.setTpl = function() {
    ...
    var screenHeight = IsPC() ? (screenWidth <= 1450 ? 800 : document.body.scrollWidth * 1080 / 1920) : '80%';
  ...
  ZdVideo.prototype.addEvents = function() {
    ...
    var playHandle = function(e) {
      obj.video.play();
      obj.bigPlayBtn.css('display', 'none');
    ...
    obj.video.addEventListener('mouseover', function() {
      ...
      if (!obj.video.paused) {
        obj.controls.addClass('show');
        obj.controls.removeClass('hide');
      }
    }, false);

    obj.video.addEventListener('mouseout', function() {
      if (!obj.video.paused) {
        obj.controls.addClass('hide');
